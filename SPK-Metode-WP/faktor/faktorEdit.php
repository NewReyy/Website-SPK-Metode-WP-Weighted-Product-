...
if (isset($_POST['update'])) {
    ...
    for ($x = 0; $x < $updateBanyak; $x++) {
        ...
        $query = $conn->query("UPDATE ta_faktor SET nilai_id = '$nilaiId[$x]', alternatif_kode = '$altKode[$x]', kriteria_kode = '$kriKode[$x]', nilai_faktor = '$nilaiFaktor[$x]' WHERE nilai_id='$nilaiId[$x]'");
