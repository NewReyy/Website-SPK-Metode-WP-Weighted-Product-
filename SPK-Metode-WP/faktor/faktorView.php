                        ...
                        <div class="col">
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $data = $conn->query("SELECT * FROM ta_alternatif ORDER BY alternatif_kode LIMIT $start, $dataPerPage");
                                    $no = $start + 1;
                                    while ($alternatif = $data->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            $sql = $conn->query("SELECT * FROM ta_faktor WHERE alternatif_kode='$alt_kode' ORDER BY kriteria_kode");
                                            ...
                                            <td>
                                                ...
                                                <a href="faktorDelete.php?id=<?= $alternatif['alternatif_kode']; ?>" class="btn btn-outline-danger" onclick="return confirm('Hapus data ini?')">Delete</a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="post" action="faktorEdit.php">
                        ...
                        <?php
                        $alt_kode = $alternatif['alternatif_kode'];
                        $sql = $conn->query("SELECT * FROM ta_faktor WHERE alternatif_kode='$alt_kode'");
                        while ($data_nilai = $sql->fetch_assoc()) { ?>
                            <div class="row mb-3">
