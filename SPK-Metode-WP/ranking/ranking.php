                            ...
                            <tbody>
                                ...
                                while ($alternatif = $query_alternatif->fetch_assoc()) { ?>
                                      <tr>
                                        ...
                                        $query_faktor = $conn->query("SELECT * FROM ta_faktor WHERE alternatif_kode='$alternatifKode' ORDER BY kriteria_kode");
                                ...
                                while ($alternatif = $query_alternatif->fetch_assoc()) { ?>
                                      <tr>
                                            ...
                                            ?>
                                                  <?php if ($kriteria['kriteria_kategori'] == "benefit") { ?>
                                                    ...
                                                    while ($kriteriaBobot_total = $sql->fetch_assoc()) { ?>
                                                        ...
                                                        <?php number_format($nilai_vektor, 4); ?>
                                        ...
                                        while ($data_faktor = $query_faktor->fetch_assoc()) { ?>
                                            ...
                                            <?php } ?>
                                        <?php } ?>
                                        <td><?= number_format($nilai_wp, 4); ?></td>
